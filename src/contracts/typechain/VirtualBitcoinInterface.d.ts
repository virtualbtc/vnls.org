...
interface VirtualBitcoinInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class VirtualBitcoinInterface extends Contract {
  ...
  interface: VirtualBitcoinInterfaceInterface;
