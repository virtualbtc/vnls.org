...
interface IVNLSBuyOrderBookInterface extends ethers.utils.Interface {
  functions: {
...
export class IVNLSBuyOrderBook extends Contract {
  ...
  interface: IVNLSBuyOrderBookInterface;
