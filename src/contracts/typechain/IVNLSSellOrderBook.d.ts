...
interface IVNLSSellOrderBookInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "Sell(uint256,address,uint256,uint256)": EventFragment;
  };
...
export class IVNLSSellOrderBook extends Contract {
  ...
  interface: IVNLSSellOrderBookInterface;
