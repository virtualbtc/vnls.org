...
interface VNLSSellOrderBookInterface extends ethers.utils.Interface {
  functions: {
...
export class VNLSSellOrderBook extends Contract {
  ...
  interface: VNLSSellOrderBookInterface;
