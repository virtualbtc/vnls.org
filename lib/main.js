...
const SaleList_1 = __importDefault(require("./exchange-v1/SaleList"));
...
const exchangeV1 = new skynode_1.DomNode(document.getElementById("exchange-v1"));
exchangeV1.append(new SaleList_1.default());
