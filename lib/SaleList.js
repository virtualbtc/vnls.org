...
class SaleList extends skynode_1.DomNode {
    constructor() {
        ...
        }), skynode_1.el("table", skynode_1.el("thead", skynode_1.el("tr", skynode_1.el("td.seller", "Seller"), skynode_1.el("td", "Amount"), skynode_1.el("td", ""), skynode_1.el("td", "Price"), skynode_1.el("td", { colspan: "2" }))), this.tbody = skynode_1.el("tbody")), skynode_1.el(".soldout", "All VBTC has been sold. Please wait for Uniswap listing."));
        this.loadVBTCAmount();
        this.loadETHAmount();
        this.loadSales();
    ...
    async loadSales() {
        ...
        (_b = this.pleaseConnect) === null || _b === void 0 ? void 0 : _b.delete();
        this.pleaseConnect = undefined;
        const owner = await Wallet_1.default.loadAddress();
        if (owner === undefined) {
            this.tbody.empty();
            this.pleaseConnect = skynode_1.el("p", "Please Connect. ", skynode_1.el("a", "Connect", {
        ...
        (_c = this.loading) === null || _c === void 0 ? void 0 : _c.delete();
